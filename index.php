...
<body>
    ...
    <section class="about container" id="about">
        <div class="contentBx">
            ...
            <p class="title-text">
                Kuis dan permainan trivia adalah cara yang menyenangkan untuk menguji pengetahuan dan
    ...
    <section class="post container" id="read">
        ...
        ?>
            <div class="post-box" onclick="openModal(this)" data-title="<?= htmlspecialchars($row['title'] ?? ''); ?>" data-category="<?= htmlspecialchars($row['category'] ?? ''); ?>" data-date="<?= htmlspecialchars($formattedDate); ?>" data-description="<?= htmlspecialchars($row['content'] ?? ''); ?>" data-image="proses/<?= htmlspecialchars($row['file_path'] ?? ''); ?>">
                ...
                <div class="post-content">
                    ...
                    <div class="profile">
                        <img src="img/testi1.jpg" alt="" class="profile-img" />
    ...
    <section class="write container" id="write">
        ...
        <div class="write-contentBx">
            ...
            <a href="#" class="btn2">Tulis triviamu</a>
        </div>
    </section>
